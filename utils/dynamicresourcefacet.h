...
namespace Nepomuk2 {
    ...
    namespace Utils {
        ...
        protected:
             ...
             */
            virtual Nepomuk2::Query::Term termForResource( const Resource& res ) const;
             ...
             */
            virtual Nepomuk2::Resource resourceForTerm( const Nepomuk2::Query::Term& queryTerm ) const;
        ...
        private:
            ...
            Q_PRIVATE_SLOT( d, void _k_newEntries( const QList<Nepomuk2::Query::Result>& ) )
